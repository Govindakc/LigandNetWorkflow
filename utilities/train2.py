...
class Train(object):
    ...
    def __init__(self, active_file, decoy_file, test_split=0.2, random_state=123, sample_threshold=20):
        ...
        # ***********added part*****************#
        self.uniprot_id = "model"
        # **************************************#

        # _, protein_name = os.path.split(active_file)
        # self.uniprot_id, _ = os.path.splitext(protein_name)
    ...
    def get_data(self):
        try:
            self.actives = self.active_file 
            self.decoys = self.decoy_file
        except Exception as e:
            print(str(e))
            return False
                
        actives_x = self.active_file
        actives_y = np.ones(len(actives_x))
        decoys_x = self.decoy_file 
    ...
    def train_models(self):
        ...
        # ****************added part**********************
        print("Please choose the name (Example type 1 for Random Forest) of the model from the following options! ")
        print("1. Random Forest Classifier")
        print("2. Extreme Gradient Boosting")
        print("3. Support Vector Classifier")
        print("4. Artificial Neural Network")
        print("5. All")
        print("6. Exit with out running any model")
        ...
        if mdl == '1':
            ...
            print('All the models are running ....')
            self.train_rf()
            self.train_xgb()
            self.train_svc()
            self.train_nn()
            ...
            print('Wrong input is given. Exiting!')
            sys.exit(1)
        # ****************added part***********************
        #print('Training xgboost..')    
        #self.train_xgb()
